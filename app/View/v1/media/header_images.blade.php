		...
		<div class="row">
			...
			@if(!$slider_images->isEmpty())
				@foreach($slider_images as $image)
					<div class='img-thumbnail col-md-3' style='height:200px;'>
					<img src='storage/images/header_images/{{ $image->image }}' alt='' class='img-rounded' width='100%' height='70%;'>
					<p style="color:#000;margin:0px;padding:0px;overflow:hidden;font-size:12px;">{{$image->image}}</p>
...
<div class='container'>
	...
	@foreach($dirs as $each)
		<div class='col-md-3 img img-thumbnail pt-2' style='margin-bottom:3%;height:200px;'>
